...
@Component
@Scope("prototype")
public class MemberCommentListNewTag extends BaseFreeMarkerTag {
...
//		}
		...
		Page commentsPage = memberCommentManager.getMemberComments(Integer.valueOf(page), pageSize,1,52);
